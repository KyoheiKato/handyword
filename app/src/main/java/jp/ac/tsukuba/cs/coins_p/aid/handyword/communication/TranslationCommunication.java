...
public class TranslationCommunication extends Thread{
    ...
    public TranslationCommunication(Translation activity) {
    ...
    public void run(){
        translation.setTranslatedString(translate(stringToTranslate));
    }
